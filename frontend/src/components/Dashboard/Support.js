  ...
  return (
    <div className="support-container">
      ...
      <div className="support_videos">
        ...
        <a
          href="https://www.youtube.com/channel/UCI1-dWB83HQEud8-SHh6bQw"
          className="youtube-link"
        >
          Visit GET-Money Support on Youtube
          <FaIcons.FaAngleRight />
        </a>
        <div>
          <img
            className="youtube"
            src="https://www.dignited.com/wp-content/uploads/2023/06/watching-Youtube3.jpg"
          ></img>
        </div>
      </div>
      ...
      <div className="side-container">
        <div className="box-left">
          ...
          <div>
            <img
              src="https://img.freepik.com/premium-vector/woman-works-laptop-computer-talks-phone-sitting-table-home-with-cup-coffee-papers_186332-271.jpg"
              alt="Image 1"
            ></img>
          </div>
        </div>
        <div className="box-right">
          ...
          <p>
            Get help for all of your issue in one place, or connect with the
            experts
          </p>
          <a
            href="https://www.youtube.com/channel/UCI1-dWB83HQEud8-SHh6bQw"
          ...
          <div>
            <img
              src="https://cdn.dribbble.com/users/1449995/screenshots/5678125/dribbble_shot_hd.png"
              alt="Image 2"
            ></img>
          </div>
        </div>
