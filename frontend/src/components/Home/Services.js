...
export default function Services() {
  return (
    <div>
      <div className="header">Global Exchange and Transaction of Money</div>
      <section className="container">
        <div className="flip-card">
          <div className="flip-card-inner">
            ...
            <div className="flip-card-back card-img-back">
              <p>
                Effortlessly exchange currencies, maximizing the value of your
                money with seamless conversion services.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flip-card">
          <div className="flip-card-inner">
            ...
            <div className="flip-card-back card-img-back">
              <p>
                Make swift transactions, assured by safety and security every
                step of the way
              </p>
            </div>
          </div>
